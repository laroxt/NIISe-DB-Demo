!(function (e, t) {
  ...
  function r() {
    ...
    (a.options.useCanvas = a.options.enableOrientation || R.call(a)),
      ...
      b(e, { width: o + (isNaN(o) ? "" : "px"), height: r + (isNaN(r) ? "" : "px") }),
      x(n, "cr-viewport"),
      s && x(n, s),
      b(n, { width: a.options.viewport.width + "px", height: a.options.viewport.height + "px" }),
      ...
      function () {
        ...
        function i(e) {
          f.elements.preview.setAttribute("aria-grabbed", e),
            f.elements.boundary.setAttribute("aria-dropeffect", e ? "move" : "none");
        }
        function e(e) {
        ...
        f.elements.overlay.addEventListener("mousedown", e),
          f.elements.viewport.addEventListener("keydown", function (e) {
            if (!e.shiftKey || (38 !== e.keyCode && 40 !== e.keyCode)) {
              ...
              (n =
                38 === e.keyCode
                  ? parseFloat(f.elements.zoomer.value) + parseFloat(f.elements.zoomer.step)
                  : parseFloat(f.elements.zoomer.value) - parseFloat(f.elements.zoomer.step)),
                f.setZoom(n);
            }
            var i, o, r, a;
        ...
        function () {
          ...
          x(m, "cr-resizer"),
            ...
            this.options.resizeControls.height &&
              (x((e = document.createElement("div")), "cr-resizer-vertical"), m.appendChild(e));
          this.options.resizeControls.width &&
            (x((t = document.createElement("div")), "cr-resizer-horisontal"), m.appendChild(t));
          function n(e) {
            if ((void 0 === e.button || 0 === e.button) && (e.preventDefault(), !i)) {
              ...
              if (
                ...
                (u = e.pageX),
                (c = e.pageY),
                (l = -1 !== e.currentTarget.className.indexOf("vertical") ? "v" : "h"),
                (h = t.width),
                (p = t.height),
                e.touches)
              ) {
          ...
          function o(e) {
            ...
            "v" === l && f <= a && a <= p
              ? (b(m, { height: a + "px" }),
                ...
                b(d.elements.boundary, { height: d.options.boundary.height + "px" }),
                (d.options.viewport.height += r),
                b(d.elements.viewport, { height: d.options.viewport.height + "px" }))
              : "h" === l &&
                f <= s &&
                s <= h &&
                (b(m, { width: s + "px" }),
                (d.options.boundary.width += o),
                b(d.elements.boundary, { width: d.options.boundary.width + "px" }),
                (d.options.viewport.width += o),
                b(d.elements.viewport, { width: d.options.viewport.width + "px" })),
              z.call(d),
              W.call(d),
              Z.call(d),
              F.call(d),
    ...
    X.call(t) &&
      ...
      t.$ && "undefined" == typeof Prototype
        ...
        : (window.CustomEvent
            ...
            : (e = document.createEvent("CustomEvent")).initCustomEvent("update", !0, !0, n),
  ...
  function W(e) {
    ...
    r.options.enforceBoundary &&
      ((i = p.width / h.width), (o = p.height / h.height), (a = Math.max(i, o))),
      s <= a && (s = a + 1),
      (l.min = A(a, 4)),
      (l.max = A(s, 4)),
      !e && (u < l.min || u > l.max)
  ...
  function O(e) {
    ...
    (s.width = u),
      (s.height = c),
      e.backgroundColor && ((l.fillStyle = e.backgroundColor), l.fillRect(0, 0, u, c));
    var h = n,
      p = i,
      d = o,
      m = r,
    ...
    return (
      ...
      d + h > this._originalImageWidth && (g = ((d = this._originalImageWidth - h) / o) * u),
      i < 0 && ((p = 0), (v = (Math.abs(i) / r) * c)),
      m + p > this._originalImageHeight && (w = ((m = this._originalImageHeight - p) / r) * c),
        ...
        if (
          (function (t) {
            this.elements.img.parentNode &&
              (Array.prototype.forEach.call(this.elements.img.classList, function (e) {
                t.classList.add(e);
              }),
  ...
  function j() {
    ...
    return (
      ...
      (s = Math.max(c, s / u)),
      (l = Math.max(c, l / u)),
      { points: [A(i), A(o), A(s), A(l)], zoom: u, orientation: e.data.orientation }
    );
  }
      ...
      "viewport" === r
        ...
        : "object" == typeof r &&
          (r.width && r.height
            ...
            : r.height && ((n.outputWidth = r.height * h), (n.outputHeight = r.height))),
