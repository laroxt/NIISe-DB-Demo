...
!(function (a) {
  jQuery.sessionTimeout = function (b) {
    function c() {
      i ||
        (a.ajax({ type: "POST", url: h.keepAliveUrl, data: h.ajaxData }),
        (i = !0),
        setTimeout(function () {
          i = !1;
        }, h.keepAliveInterval));
    ...
    function d() {
      clearTimeout(f),
        ...
        (f = setTimeout(function () {
          "function" != typeof h.onWarn
            ? a("#sessionTimeout-dialog").modal("show")
            : h.onWarn("warn"),
            e();
        }, h.warnAfter));
    }
    function e() {
      clearTimeout(f),
        (f = setTimeout(function () {
          "function" != typeof h.onRedir
            ? (e("start"), (window.location = h.redirUrl))
            : h.onRedir();
    ...
    var f,
      ...
      h = g;
    if ((b && (h = a.extend(g, b)), h.warnAfter >= h.redirAfter))
      return (
    ...
    "function" != typeof h.onWarn &&
      (a("body").append(
        '<div class="modal fade" id="sessionTimeout-dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><' +
          h.heading +
          ' class="modal-title">' +
          h.title +
          "</" +
          ...
          h.message +
          '</div><div class="modal-footer"><button id="sessionTimeout-dialog-keepalive" type="button" class="' +
          h.keepBtnClass +
          '" data-dismiss="modal">' +
          h.keepBtnText +
          '</button><button id="sessionTimeout-dialog-logout" type="button" class="' +
          h.logoutBtnClass +
          '">' +
          h.logoutBtnText +
          "</button></div></div></div></div>"
      ),
      a("#sessionTimeout-dialog-logout").on("click", function () {
        window.location = h.logoutUrl;
      }),
      a("#sessionTimeout-dialog").on("hide.bs.modal", function () {
        d();
      })),
      h.ignoreUserActivity ||
